  ...
  const faqCategories = [
    {
      ...
      questions: [
        ...
        },
        {
          ...
          answer: "Simply connect your Web3 wallet by clicking the 'Connect Wallet' button in the top right. No registration or personal information required. Once connected, you'll have immediate access to all platform features."
        },
        {
          question: "Do I need cryptocurrency to use CODEX?",
          answer: "You need a Web3 wallet to access the platform. Some features like browsing and exploring are free, but active trading, staking, and transactions require cryptocurrency for gas fees and platform operations."
        },
        {
          question: "Which wallets are supported?",
          answer: "CODEX supports any wallet compatible with the Ethereum Provider API (browser-based Web3 wallets). We support multiple chains including Ethereum, Base, Polygon, Arbitrum, Optimism, and BSC."
        }
      ]
    },
    {
      ...
      questions: [
        {
          question: "How does the Sentinel Trading Bot work?",
          answer: "Our AI trading bot uses multiple strategies and adapts to market conditions in real-time. Past performance doesn't guarantee future results. All trading involves risk - start with amounts you can afford to lose."
        },
        {
        ...
        },
        {
          ...
          answer: "You can start with as little as $100, but we recommend $500+ for better strategy diversification. The bot connects to supported exchange APIs for actual trade execution."
        },
        {
      ...
      questions: [
        {
          ...
          answer: "APY varies by pool and changes based on market conditions. Our DeFi staking pools offer competitive yields with auto-compounding via decentralized lending protocols. Rates are not guaranteed and fluctuate based on protocol activity."
        },
        {
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          answer: "All payments route directly to your configured wallet address. You have immediate, full control over your funds - no middleman holding your money."
        },
        {
      ...
      questions: [
        {
          ...
          answer: "Yes. We use industry-standard encryption, smart contract audits, and follow security best practices. However, you're responsible for your wallet security - never share private keys or seed phrases with anyone."
        },
        {
      ...
      questions: [
        {
          ...
          answer: "To delete your account: 1) Open the CODEX app, 2) Go to Settings (gear icon), 3) Navigate to Account section, 4) Click 'Delete Account', 5) Enter your password to confirm. Your account and personal data will be permanently deleted. Note: Financial transaction records and KYC/AML data are retained for 5-7 years as required by law. Blockchain transactions are permanent and cannot be deleted."
        },
        {
          question: "What data is deleted when I delete my account?",
          answer: "When you delete your account, we immediately remove: your email, profile information, preferences, session data, and app analytics. However, financial transaction records (7 years) and KYC/AML verification data (5-7 years) must be retained per regulatory requirements. Public blockchain transactions are permanent by design."
        },
        {
          question: "Can I request data deletion via email?",
          answer: "Yes! If you cannot access the app, email omniversesyndicate@gmail.com with subject 'Account Deletion Request' and include your registered email address. We'll process your request within 30 days, subject to regulatory data retention requirements."
        },
        {
          question: "How long does account deletion take?",
          answer: "Account deletion is immediate - you'll lose access instantly. Personal data is removed within 90 days. Financial records (7 years) and KYC/AML data (5-7 years) are retained as legally required and disclosed in our Privacy Policy."
        }
      ]
    },
    {
      ...
      questions: [
        {
          ...
          answer: "Platform fees vary by feature and are always displayed before you confirm any transaction. Contact us for current fee structures. Gas fees (paid to blockchain validators) vary by network congestion."
        },
        {
