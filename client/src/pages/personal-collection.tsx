...
const leviathanImg = "";
const tokensImg = "";
const memoryScrollImg = "";
const kaylinRelicImg = "";
const masterCodexImg = "";
const royalFlushImg = "";
const codexBtcImg = "";
const omniverseImg = "";
...
const tokens = [
  ...
  },
  {
    ...
    name: "CDX Token",
    symbol: "CDX",
    description: "Royal key to unlock CODEX rewards",
    image: tokensImg,
    type: "Legendary",
    features: ["CODEX Staking", "Key Holder Benefits"]
  },
  {
    id: 5,
    name: "G.O.A.T. Token",
...
const relics = [
  ...
  },
  {
    ...
    type: "Codexkey333 Relic",
    description: "CODEX Balance 333 - Master control relic",
  ...
  },
  {
    ...
    type: "Platform VIP",
    description: "Ultimate platform VIP pass - 1,000 Vault Chips",
    image: royalFlushImg,
    power: "Royal Status",
