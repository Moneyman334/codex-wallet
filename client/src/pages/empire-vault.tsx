    ...
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12 relative z-10">
        ...
        <div className="text-center mb-12">
          <Badge className="px-6 py-3 text-xl bg-gradient-to-r from-yellow-500 via-amber-500 to-orange-500 text-black border-none font-black platform-glow-mega mb-4" data-testid="hero-badge">
            <Crown className="inline h-6 w-6 mr-2" />
            EMPIRE VAULT
            <Sparkles className="inline h-6 w-6 ml-2" />
          </Badge>
          
          <h1 className="text-6xl md:text-7xl font-black mb-4 platform-sign">
            DAO TREASURY
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
          <Card className="card-platform hover-explode" data-testid="stat-total-balance">
          ...
          <Card className="card-platform hover-explode" data-testid="stat-total-deposited">
            <CardHeader className="pb-3">
              <div className="flex items-center justify-between">
          ...
          <Card className="card-platform hover-explode" data-testid="stat-total-distributed">
            <CardHeader className="pb-3">
              <div className="flex items-center justify-between">
          ...
          <Card className="card-platform hover-explode" data-testid="stat-last-distribution">
            <CardHeader className="pb-3">
              <div className="flex items-center justify-between">
        ...
        {connectedWallet && (
          <Card className="mb-12 electric-card p-8 platform-spotlight" data-testid="pending-rewards-card">
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
        ...
        {/* Revenue Breakdown */}
        <Card className="mb-12 card-platform" data-testid="revenue-breakdown-card">
          <CardHeader>
        ...
        {/* How It Works */}
        <Card className="card-platform" data-testid="how-it-works-card">
          <CardHeader>
            <CardTitle className="text-3xl font-black text-neon-yellow mb-2">
