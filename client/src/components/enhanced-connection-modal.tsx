      ...
      const options: WalletOption[] = [
        {
          id: 'web3wallet',
          name: 'Web3 Wallet',
          description: 'Connect your browser wallet',
          icon: '🔗',
          isInstalled: hasWeb3Wallet,
          isRecommended: true,
          color: 'bg-purple-500',
              ...
              <div className="text-center space-y-4 p-6">
                ...
                <Alert className="text-left">
                  ...
                  <AlertDescription className="text-sm space-y-2">
                    ...
                    <p><strong>Step 2:</strong> Open your Web3 wallet app on your phone</p>
          ...
          <TabsContent value="help" className="space-y-4 mt-4">
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <ul className="space-y-2 text-sm text-muted-foreground">
                  <li className="flex items-start gap-2">
                    ...
                    <span><strong>Wallet not detected:</strong> Make sure you have a Web3 wallet browser extension installed</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-purple-400 mt-0.5">•</span>
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  You'll need a Web3 wallet browser extension to connect. Search for "Web3 wallet" in your browser's extension store to get started.
                </p>
              </div>
            </div>
          </TabsContent>
