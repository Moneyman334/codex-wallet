...
const navigationItems = [
  ...
  { path: "/billionaire-mode", label: "Billionaire Mode", icon: Crown, featured: true },
  ...
  { path: "/codex-pay", label: "CODEX Pay", icon: Zap, featured: true },
  { path: "/codex-atm", label: "CODEX ATM", icon: DollarSign, featured: true },
  { path: "/dex-aggregator", label: "DEX Aggregator", icon: TrendingUp, featured: true },
  { path: "/trading-bot", label: "AI Trading Bot", icon: Bot, featured: true },
  { path: "/copy-trading", label: "Copy Trading", icon: Users, featured: true },
  { path: "/nft-marketplace", label: "NFT Marketplace", icon: Image, featured: true },
  { path: "/trade", label: "Trade Crypto", icon: TrendingUp, featured: true },
  { path: "/live-trading", label: "Live Trading", icon: Activity, featured: true },
