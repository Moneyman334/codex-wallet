...
const tourSteps: TourStep[] = [
  ...
  },
  {
    ...
    description: "Start by connecting your Web3 wallet. This gives you access to all platform features - trading, staking, NFT creation, and more. No personal info required!",
  ...
  },
  {
    ...
    description: "Our Sentinel Bot trades for you 24/7 using multiple strategies. Set your risk level and let AI analyze market conditions. Trading involves risk.",
  ...
  {
    title: "DeFi Staking",
    description: "Stake your crypto via DeFi protocols with auto-compounding. Yields vary based on market conditions. Not financial advice.",
